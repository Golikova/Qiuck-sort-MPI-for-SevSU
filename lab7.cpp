...
//	MPI_Alltoall(leftSub,elementsPerProcess,MPI_INT,Sorted1,elementsPerProcess,MPI_INT,MPI_COMM_WORLD);
//	MPI_Alltoall(rightSub,elementsPerProcess,MPI_INT,Sorted2,elementsPerProcess,MPI_INT,MPI_COMM_WORLD);
